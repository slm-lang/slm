...
Template.prototype.compile = function(src, compileOptions, vm) {
  var vm = vm || new this.VM();

  var fn = this.exec(src, compileOptions, vm);
...
Template.prototype.exec = function(src, compileOptions, vm) {
  ...
  vm.template = this;
  vm.basePath = compileOptions.basePath;
  vm.filename = compileOptions.filename;
  vm.require  = compileOptions.require || module.require;
  vm.rebind();
