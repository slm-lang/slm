var Engine = require('./engine'),
  ...
  AttributeMerger = require('./filters/attribute_merger'),
...
function Template() {
  ...
  this.engine.use(new AttributeMerger);
...
Template.prototype.render = function(src) {
  ...
  return 'function(context) {\n' + res + Utils.escape.toString() + ';' + Utils.safe.toString() + ';' + Utils.rejectEmpty.toString() + '; var slm = {escape: escape, safe: safe, rejectEmpty: rejectEmpty}; ' + this.engine.exec(src) + '}';
};
