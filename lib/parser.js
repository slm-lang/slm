...
(function() {
  ...
  this.parseAttributes = function(attributes) {
    ...
    while (true) {
      // Splat attribute
      if (m = this.splatAttributeRe.exec(this.line)) {
        this.line = this.line.slice(m[0].length);
      ...
      this.line = this.line.repace(this.indentationRe, '');
      if (this.line.length) {
  ...
  this.parseJSCode = function(outerDelimeter) {
    ...
    while (!(this.line.length === 0 || (count === 0 && endRe.test(this.line)))) {
