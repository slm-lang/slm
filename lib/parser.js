...
(function() {
  ...
  this.parseLineIndicators = function() {
    do {
      ...
      // HTML comment
      if (m = this.htmlCommentRegex.test(this.line)) {
      ...
      if (m = this.htmlConditionalCommentRegex.exec(this.line)) {
        var block = ['multi'];
      ...
      // Text block.
      if (m = this.textBlockRegex.exec(this.line)) {
      ...
      // Output block.
      if (m = this.outputBlockRegex.exec(this.line)) {
        // We expect the line to be broken or the next line to be indented.
      ...
      // Embedded template.
      if (m = this.embededRegex.exec(this.line)) {
      ...
      // Doctype declaration
      if (m = this.doctypeRegex.exec(this.line)) {
  ...
  this.parseBrokenLine = function() {
    ...
    while (this.nextLineRegex.test(brokenLine)) {
      this.expectNextLine();
      brokenLine += "\n" + this.line;
    }
    return brokenLine;
  ...
  this.parseQuotedAttribute = function(quote) {
    ...
    while (this.line.length && !(count === 0 && this.line[0] === quote)) {
      if (/^\\$/.test(this.line)) {
        value += ' ';
        this.expectNextLine();
      } else {
